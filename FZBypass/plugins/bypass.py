...
async def start_msg(client, message):
    await message.reply(f'''<b><i>MAH Bypass Bot!</i></b>
    
    <i>A Powerful Elegant Multi Threaded Bot written in Python... which can Bypass Various Shortener Links, Scrape links, and More ... </i>
    
    <i><b>Bot Started {convert_time(time() - BOT_START)} ago...</b></i>

🛃 <b>Use Me Here :</b> @Free_Leech_Group_4GB <i>(Bypass Topic)</i>''',
        quote=True,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('🎓 Dev', url='https://t.me/Mahsoommjm'), InlineKeyboardButton('🔍 Deploy Own', url="https://t.me/Call_me_futurepilot")]
            ])
    )
